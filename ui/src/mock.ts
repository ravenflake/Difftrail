...
const validation: ValidationReport = {
  ...
  scans: { total: 14, quiet: 10, quiet_rate: 10 / 14, changes: 4, symptoms: 2, provider_error_count: 0, provider_error_buckets: {}, sources_per_scan_mean: 7, change_bearing_scan_rate: 4 / 14 },
  ...
  investigations: { total: 2, with_feedback: 1, outcomes: { correct: 1, incorrect: 0, unknown: 0 }, correct_cause_top3_hits: 1, correct_cause_top3_rate: 1, rank_distribution: { "1": 1 } },
